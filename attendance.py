...
class Face_Recognizer:
    ...
    # Face detection and recognition with OT from picamera2
    def process_picamera(self):
        ...
        if self.get_face_database():
            ...
            while True:
                ...
                img_rd = self.picam2.capture_array()
                
                # Convert to BGR format (dlib/OpenCV compatibility)
