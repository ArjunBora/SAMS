...
class Face_Register:
    def __init__(self):
        ...
        self.picam2.start()   # Get video stream from camera
        ...
        if self.face_folder_created_flag:
            ...
            if self.current_frame_faces_cnt == 1:
                ...
                if not self.out_of_range_flag:
                    ...
                    logging.info("%-40s %s/img_face_%s.jpg", "Save intoÃ¯Â¼Å¡",
    ...
    def get_frame(self):
        ...
        frame = self.picam2.capture_array()  # Capture image
    ...
    def process(self):
        ...
        if ret:
            ...
            faces = detector(gray_frame, 0)  # Use grayscale image for dlib
            ...
            if len(faces) != 0:
                ...
                for k, d in enumerate(faces):
                    ...
                    cv2.rectangle(self.current_frame, (d.left() - self.ww, d.top() - self.hh),
                              ...
                              (d.right() + self.ww, d.bottom() + self.hh), color_rectangle, 2)
